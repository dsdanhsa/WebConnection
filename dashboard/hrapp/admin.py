...
from .models import BenefitPlans, Personal, EmploymentWorkingTime, Employment, JobHistory
...
class EmploymentAdmin(admin.ModelAdmin):
    list_display = ['EMPLOYMENT_ID', 'EMPLOYMENT_CODE', 'EMPLOYMENT_STATUS', 'HIRE_DATE_FOR_WORKING', 'WORKERS_COMP_CODE', 'TERMINATION_DATE', 'REHIRE_DATE_FOR_WORKING', 'LAST_REVIEW_DATE','NUMBER_DAYS_REQUIREMENT_OF_WORKING_PER_MONTH', 'personal']
